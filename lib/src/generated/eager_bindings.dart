...
class EagerBindings implements AbstractBindings {
  EagerBindings(DynamicLibrary library)
    : _getDeviceCount = library
      ...
      _cancelAsync = library.lookupFunction<NativeCancelAsync, DartCancelAsync>(
        'rtlsdr_cancel_async',
      ),
