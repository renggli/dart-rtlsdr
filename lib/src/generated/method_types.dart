...
typedef NativeGetDeviceUsbStrings = Int Function(
  Uint32 index,
  Pointer<Utf8> manufact,
  Pointer<Utf8> product,
  Pointer<Utf8> serial,
);
typedef DartGetDeviceUsbStrings = int Function(
  int index,
  Pointer<Utf8> manufact,
  Pointer<Utf8> product,
  Pointer<Utf8> serial,
...
typedef NativeOpen = Int Function(
  Pointer<Pointer<DeviceHandle>> dev,
  Uint32 index,
);
...
typedef NativeGetXtalFreq = Int Function(
  Pointer<DeviceHandle> dev,
  Pointer<Uint32> rtlFreq,
  Pointer<Uint32> tunerFreq,
);
typedef DartGetXtalFreq = int Function(
  Pointer<DeviceHandle> dev,
  Pointer<Uint32> rtlFreq,
  Pointer<Uint32> tunerFreq,
);
...
typedef NativeGetUsbStrings = Int Function(
  Pointer<DeviceHandle> dev,
  Pointer<Utf8> manufact,
  Pointer<Utf8> product,
  Pointer<Utf8> serial,
);
typedef DartGetUsbStrings = int Function(
  Pointer<DeviceHandle> dev,
  Pointer<Utf8> manufact,
  Pointer<Utf8> product,
  Pointer<Utf8> serial,
...
typedef NativeReadAsync = Int Function(
  Pointer<DeviceHandle> dev,
  Pointer cb,
  Pointer<Void> ctx,
  Uint32 bufNum,
...
typedef DartReadAsync = int Function(
  Pointer<DeviceHandle> dev,
  Pointer cb,
  Pointer<Void> ctx,
  int bufNum,
