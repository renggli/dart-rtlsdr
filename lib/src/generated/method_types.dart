...
typedef NativeGetDeviceUsbStrings =
    Int Function(
      Uint32 index,
...
typedef DartGetDeviceUsbStrings =
    int Function(
      int index,
      Pointer<Utf8> manufact,
      Pointer<Utf8> product,
...
typedef NativeOpen =
    Int Function(Pointer<Pointer<DeviceHandle>> dev, Uint32 index);
...
typedef NativeSetXtalFreq =
    Int Function(Pointer<DeviceHandle> dev, Uint32 rtlFreq, Uint32 tunerFreq);
typedef DartSetXtalFreq =
    int Function(Pointer<DeviceHandle> dev, int rtlFreq, int tunerFreq);

// int rtlsdr_get_xtal_freq(rtlsdr_dev_t *dev, uint32_t *rtl_freq, uint32_t *tuner_freq)
typedef NativeGetXtalFreq =
    Int Function(
      Pointer<DeviceHandle> dev,
      Pointer<Uint32> rtlFreq,
      Pointer<Uint32> tunerFreq,
    );
typedef DartGetXtalFreq =
    int Function(
      Pointer<DeviceHandle> dev,
      Pointer<Uint32> rtlFreq,
      Pointer<Uint32> tunerFreq,
...
typedef NativeSetCenterFreq =
    Int Function(Pointer<DeviceHandle> dev, Uint32 freq);
...
typedef NativeSetFreqCorrection =
    Int Function(Pointer<DeviceHandle> dev, Int ppm);
typedef DartSetFreqCorrection =
    int Function(Pointer<DeviceHandle> dev, int ppm);
...
typedef NativeGetTunerGains =
    Int Function(Pointer<DeviceHandle> dev, Pointer<Int> gains);
typedef DartGetTunerGains =
    int Function(Pointer<DeviceHandle> dev, Pointer<Int> gains);
...
typedef NativeSetTunerBandwidth =
    Int Function(Pointer<DeviceHandle> dev, Uint32 bw);
...
typedef NativeSetTunerIfGain =
    Int Function(Pointer<DeviceHandle> dev, Int stage, Int gain);
typedef DartSetTunerIfGain =
    int Function(Pointer<DeviceHandle> dev, int stage, int gain);

// int rtlsdr_set_tuner_gain_mode(rtlsdr_dev_t *dev, int manual)
typedef NativeSetTunerGainMode =
    Int Function(Pointer<DeviceHandle> dev, Int manual);
typedef DartSetTunerGainMode =
    int Function(Pointer<DeviceHandle> dev, int manual);

// int rtlsdr_set_sample_rate(rtlsdr_dev_t *dev, uint32_t rate)
typedef NativeSetSampleRate =
    Int Function(Pointer<DeviceHandle> dev, Uint32 rate);
...
typedef NativeSetDirectSampling =
    Int Function(Pointer<DeviceHandle> dev, Int on);
...
typedef NativeWaitAsync =
    Int Function(Pointer<DeviceHandle> dev, Pointer cb, Pointer<Void> ctx);
typedef DartWaitAsync =
    int Function(Pointer<DeviceHandle> dev, Pointer cb, Pointer<Void> ctx);

// int rtlsdr_read_async(rtlsdr_dev_t *dev, rtlsdr_read_async_cb_t cb, void *ctx, uint32_t buf_num, uint32_t buf_len)
typedef NativeReadAsync =
    Int Function(
      Pointer<DeviceHandle> dev,
      Pointer cb,
      Pointer<Void> ctx,
